...
const wishList = [
  {
    text: "Chúc DaoUyen và gia đình một mùa Trung Thu đoàn viên, tràn ngập niềm vui và hạnh phúc!",
    img: "./assets/1.jpg",
  },
  {
    text: "Cầu chúc cho mọi nguyện ước của bạn đêm nay sẽ trở thành hiện thực.",
    img: "./assets/2.jpg",
  },
  {
